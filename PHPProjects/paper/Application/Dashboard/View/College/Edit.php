      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
            ...
            <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="{:U('College/UpdateCollege')}">
              ...
              <div class="am-g am-margin-top-sm">
                ...
                <div class="am-u-sm-4 am-u-end">
                  ...
                  <input type="text" class="am-input-sm" name="college_name" id="college_name" value="{$data[0].college_name}">
                </div>
              </div>
