      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="{:U('Room/UpdateRoom')}">
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <input STYLE="width: 250px;" value="{$data.room_name}" type="text" class="col-sm-6 col-xs-12" name="title" id="title">
                      </div>
                    </div>
                  </div>
                </fieldset>
