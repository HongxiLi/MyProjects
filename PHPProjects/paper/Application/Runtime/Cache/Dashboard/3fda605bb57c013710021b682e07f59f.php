              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Message/AddMsg');?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="checkbox" name="u[]" value="<?php echo ($vo["id"]); ?>">
                      <?php echo ($vo["username"]); endforeach; endif; else: echo "" ;endif; ?>
                  </div>
                </div>
