      ...
      <div class="am-u-sm-12">
            ...
            <div class="am-fl am-cf">
              <div class="am-btn-toolbar am-fl">
                <div class="am-btn-group am-btn-group-xs">
                  <button onclick=javascript:window.location.href="<?php echo U('CT/SY');?>"; type="button" class="am-btn am-btn-default"><span class="am-icon-bug"></span> 返回</button>
                </div>
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Semester/UpdateSemester');?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    <input type="number" class="col-sm-6 col-xs-12" name="yname" id="yname" value="<?php echo ($data[0]["year"]); ?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    <select class="form-control" name="sep_half" id="">
                      <option <?php if($data[0]['sep_half'] == 0): ?>selected<?php endif; ?> value="0">上学期</option>
                      <option <?php if($data[0]['sep_half'] == 1): ?>selected<?php endif; ?> value="1">下学期</option>
                    </select>
                  </div>
                </div>
