      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Class/AddClass');?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    ...
                    <select class="form-control col-sm-6 col-xs-12" name="college" id="college">
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["college_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                </div>
