 ...
 if(!empty($m['sub'])) { ?>
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">控制中心 <small>>店铺列表.</small></h2>
        </div>
      </div>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="widget-content">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="tableData">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td class=""><?php echo ($vo["shop_name"]); ?></td>
                                   ...
                                   <!--  <td class="hidden-xs">
                                    ...
                                    <td class="hidden-xs">
                                        <?php echo ($vo["tel"]); ?></td>
                                    <td class="hidden-xs">
                                        <?php echo ($vo["address"]); ?></td> -->
                                    <td class="center">
                                        <a href="<?php echo U('Shop/Edit?id='.$vo['id'].'');?>">
                                            <i class="icon-edit"></i>
                                        </a>
                                        |
                                        <a class="deleteBtn" href="<?php echo U('Shop/Delete?id='.$vo['id'].'');?>">
