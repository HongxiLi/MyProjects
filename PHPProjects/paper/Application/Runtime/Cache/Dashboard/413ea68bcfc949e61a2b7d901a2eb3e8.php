 ...
 if(!empty($m['sub'])) { ?>
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">控制中心 <small>>添加产品.</small></h2>
        </div>
      </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <form data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="form" action="<?php echo U('Product/AddProduct');?>" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        <div class="col-md-3">
                                            <label for="" class="control-label">所属类别</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="col-sm-6 col-xs-12"  name="url" id="url" value="http://"/>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#postBtn").click(function(e){
            ...
            var url = $("#url").val();
            var thumb = $("#thumb").val();
            var thumb2 = $("#thumb2").val();
            var content = $("#content").val();

            if(title==""||url==""||thumb==""||thumb2=="")
            {
                $("#msg").html("表单不能为空");
                return;
            }
