    ...
    <div class="am-g" style="padding: 10px;border: 1px solid #ddd;margin-left: 15px;margin-right: 15px;">
      <div class="am-u-sm-12">
        <div class="am-cf " style="padding-bottom: 10px;">
          <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">学院数据</strong> / <small>更新</small></div>
        </div>
        <div class="am-g">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
            ...
            <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('College/UpdateCollege');?>">
              ...
              <div class="am-g am-margin-top-sm">
                ...
                <div class="am-u-sm-4 am-u-end">
                  ...
                  <input type="text" class="am-input-sm" name="college_name" id="college_name" value="<?php echo ($data[0]["college_name"]); ?>">
                </div>
              </div>
