                    ...
                    <div class="widget-content">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="display" id="tableData">
                            ...
                            <tr>
                                <th>编号</th>
                                <th class="">产品名称</th>
<th class="hidden-xs">所属类别</th>
                                <th class="hidden-xs">封面</th>
                                <th class="hidden-xs">大图</th>
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                    ...
                                    <td class=""><?php echo ($vo["product_name"]); ?></td>
<td class=""><?php echo ($vo["category"]); ?></td>
                                    <td class="hidden-xs">
									
                                        <a href="http://127.0.0.1:9058//<?php echo ($vo["thumb"]); ?>" target="_blank">
                                            <img width="80" height="45" src="http://127.0.0.1:9058//<?php echo ($vo["thumb"]); ?>" alt=""/>
                                        </a>

                                    </td>
									<td class="hidden-xs">
									
                                        <a href="http://127.0.0.1:9058//<?php echo ($vo["thumb2"]); ?>" target="_blank">
                                            <img width="80" height="45" src="http://127.0.0.1:9058//<?php echo ($vo["thumb2"]); ?>" alt=""/>
                                        </a>

                                    </td>
                                    <!-- <td class="hidden-xs">
                                    									<?php if(!empty($vo['qrcode'])){?>
                                        <a href="http://127.0.0.1:9058//{$vo.qrcode}" target="_blank">
                                    ...
                                    <td class="hidden-xs">
                                        <?php echo ($vo["url"]); ?></td>
                                    <td class="center">
                                        <a href="<?php echo U('Product/Edit?id='.$vo['id'].'');?>">
                                            <i class="icon-edit"></i>
                                        </a>
                                        |
                                        <a class="deleteBtn" href="<?php echo U('Product/Delete?id='.$vo['id'].'');?>">
