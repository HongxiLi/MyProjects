      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Student/UpdateStudent');?>">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 252px;" READONLY type="text" class="col-sm-6 col-xs-12" name="username" id="username" value="<?php echo ($data[0]["username"]); ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input  style="width: 152px;" type="text" name="realname" class="col-sm-6 col-xs-12" value="<?php echo ($data[0]["realname"]); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width: 80px;" name="sex" class="form-control" id="">
                          <option <?php if($data[0]['sex'] == 1): ?>selected<?php endif; ?> value="1">男</option>
                          <option <?php if($data[0]['sex'] == 2): ?>selected<?php endif; ?> value="2">女</option>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width: 80px;" name="year" class="form-control" id="">
                          <?php if(is_array($data2)): $i = 0; $__LIST__ = $data2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['year']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["year"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width: 152px;" name="college" class="form-control" id="college">
                          <?php if(is_array($data1)): $i = 0; $__LIST__ = $data1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['college']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["college_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width: 152px;" name="major" class="form-control" id="major">
                          <?php if(is_array($data3)): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['major']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["major_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width: 152px;" name="class" class="form-control" id="class">
                          <?php if(is_array($data4)): $i = 0; $__LIST__ = $data4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['class']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["class_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                      </div>
                    </div>
                  </div>
