...
<!--        </div>-->
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">首页</strong> / <small>我的论文</small></div>
    </div>
    ...
    <div class="am-g" style="padding: 10px;border: 1px solid #ddd;margin-left: 15px;margin-right: 15px;">
      <div class="am-u-sm-12">
        <div class="am-cf " style="padding-bottom: 10px;">
          <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">我的论文</strong> / <small>重新上传</small></div>
        </div>
        <div class="am-g">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form enctype="multipart/form-data"  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('CourseControl/Upload2');?>">


                <div class="am-g am-margin-top-sm">
                  <div class="am-u-sm-2 am-text-right">
                    <label for="" class="control-label">选择论文</label>
                  </div>
                  <div class="am-u-sm-4 am-u-end">
                    <input required type="file" class="col-sm-6 col-xs-12" name="thumb" id="">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    <button id="postBtn" class="am-btn am-btn-primary am-btn-xs" type="submit">上传</button>
