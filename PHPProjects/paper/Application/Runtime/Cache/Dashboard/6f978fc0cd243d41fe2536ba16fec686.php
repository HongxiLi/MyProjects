...
<!--        </div>-->
  ...
  <div class="admin-content">
    ...
    <ul class="am-avg-sm-1 am-avg-md-4 am-margin am-padding am-text-center admin-content-list ">
      <li><a href="javascript:;" class="am-text-success"><span class="am-icon-btn am-icon-file-text"></span><br/>论文<br/><?php echo ($slist); ?></a></li>
      <li><a href="javascript:;" class="am-text-warning"><span class="am-icon-btn am-icon-briefcase"></span><br/>小组<br/><?php echo ($clist); ?></a></li>
      <li><a href="javascript:;" class="am-text-danger"><span class="am-icon-btn am-icon-recycle"></span><br/>访问数<br/><?php echo ($configuration[0]["count"]); ?></a></li>
      <li><a href="javascript:;" class="am-text-secondary"><span class="am-icon-btn am-icon-user-md"></span><br/>用户数<br/><?php echo ($ulist); ?></a></li>
    </ul>
