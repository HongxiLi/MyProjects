      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Teacher/UpdateTeacher');?>">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width:250px;" READONLY type="text" class="col-sm-6 col-xs-12" name="username" id="username" value="<?php echo ($data[0]["username"]); ?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width:250px;" type="text" name="realname" class="col-sm-6 col-xs-12" value="<?php echo ($data[0]["realname"]); ?>" />
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <select style="width:150px;" name="zc" class="form-control" id="">
                          <option <?php if('教授' == $data[0]['zc']): ?>selected<?php endif; ?> value="教授">教授</option>
                          <option <?php if('副教授' == $data[0]['zc']): ?>selected<?php endif; ?> value="副教授">副教授</option>
                          <option <?php if('助教' == $data[0]['zc']): ?>selected<?php endif; ?> value="助教">助教</option>
                        </select>
                      </div>
                    </div>
                  </div>
