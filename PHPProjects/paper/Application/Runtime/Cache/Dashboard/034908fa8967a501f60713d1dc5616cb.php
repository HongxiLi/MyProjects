...
<?php
if(!empty($list1)) { foreach($list1 as $i=>$l) { if(empty($l['SeleData'])) continue; ?>
        <div class="widget">
            <div class="widget-header"> <i class="icon-table"></i>
                <h3><?php echo $l['semester_field'];?> 预选信息</h3>
            </div>
 ...
 foreach($l['SeleData'] as $m=>$vo){ ?>
                        <tr class="gradeX">
                            ...
                            <td class="center">
                                ...
                                <a href="<?php echo U('CourseControl/Submit?id='.$vo['sele']['id'].'');?>">

                                    [<i class="icon icon-check"></i> 选课]
                                </a>


                                    <a href="<?php echo U('CourseControl/Delete?id='.$vo['sele']['id'].'');?>">

                                        [<i class="icon icon-trash"></i> 弃选]
                                    </a>
                            </td>
                        </tr>
                    <?php }?>
