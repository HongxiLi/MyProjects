    ...
    private void showAlertDialog() {
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                for(Order o:cart)
                {
                    for(Food f:Common.getMyFoods())
                    {
                        if(o.getProductName().equals(f.getName()))
                        {
                            if(Integer.parseInt(o.getQuantity())>f.getCount()) {
                                request.setAvailable("0");
                            }
                            else {
                                int a = f.getCount();
                                f.setCount(a - Integer.parseInt(o.getQuantity()));
                            }
                        }
                    }
                }
