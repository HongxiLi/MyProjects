...
public class UserInfo {
    ...
    public UserInfoDirectory rdriverInfoDirectory;
    
    public UserInfo(){
        rdriverInfoDirectory = new UserInfoDirectory();
        this.status = 0;
    }
    ...
    public UserInfoDirectory getRdriverInfoDirectory() {
        return rdriverInfoDirectory;
    }

    public void setRdriverInfoDirectory(UserInfoDirectory rdriverInfoDirectory) {
