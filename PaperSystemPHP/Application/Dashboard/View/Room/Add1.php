            ...
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <form data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="form" action="{:U('Room/AddRoom')}" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text" class="col-sm-6 col-xs-12" name="room_name" id="title">
                                            </div>
                                        </div>
                                    </div>
