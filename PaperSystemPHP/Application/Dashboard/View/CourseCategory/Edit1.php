            ...
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <form data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="form" action="{:U('CourseCategory/UpdateCategory')}" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                ...
                                                <input value="{$data.category_name}" type="text" class="col-sm-6 col-xs-12" name="title" id="title">
                                            </div>
                                        </div>
                                    </div>
