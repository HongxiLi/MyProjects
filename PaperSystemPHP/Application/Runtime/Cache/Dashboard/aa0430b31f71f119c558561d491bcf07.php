...
<div class="wrapper">
 ...
 if(!empty($m['sub'])) { ?>
  ...
  <div class="page-content">
    <div class="content container">
      <div class="row">
        <div class="col-lg-12">
          <h2 class="page-title">控制中心 <small>>编辑产品.</small></h2>
        </div>
      </div>
        <div class="row">
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <form data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="form" action="<?php echo U('Product/UpdateProduct');?>" enctype="multipart/form-data">
                                <fieldset>

                                    <div class="control-group">
                                        <div class="col-md-3">
                                            <label for="" class="control-label">产品名称</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input value="<?php echo ($data["product_name"]); ?>" type="text" class="col-sm-6 col-xs-12" name="title" id="title">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <a href="http://127.0.0.1:9058//<?php echo ($data["thumb"]); ?>" target="_blank">
                                                    <img width="120" height="120" src="http://127.0.0.1:9058//<?php echo ($data["thumb"]); ?>" alt=""/>
                                                </a>
									 ...
									 <div class="control-group">
                                        <div class="col-md-3">
                                            <label for="" class="control-label">产品大图</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
											 <a href="http://127.0.0.1:9058//<?php echo ($data["thumb2"]); ?>" target="_blank">
                                                    <img width="120" height="120" src="http://127.0.0.1:9058//<?php echo ($data["thumb2"]); ?>" alt=""/>
                                                </a>
                                                <input type="file"  name="thumb2" id="thumb2"/>
                                                <input type="hidden" name="old_thumb2" value="<?php echo ($data["thumb2"]); ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                   <div class="control-group">
                                        <div class="col-md-3">
                                            <label for="" class="control-label">所属类别
											（当前为<?php echo ($data["category"]); ?>）</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <select style="width: 45%;" class="form-control" name="category" id="parent">
                                                   <option value="主机/通信">主机/通信</option>
 ...
 <div class="control-group">
                                        <div class="col-md-3">
                                            <label for="" class="control-label">产品网店链接</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <input type="text"  name="url" id="url" value="<?php echo ($data["url"]); ?>"/>
                                                                        ...
                                                                        <input type="hidden" name="content" value="unupload">
                                    <div class="control-group">
