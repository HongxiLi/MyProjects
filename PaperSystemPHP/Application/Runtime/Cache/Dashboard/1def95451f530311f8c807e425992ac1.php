    ...
    <div class="am-g" style="padding: 10px;border: 1px solid #ddd;margin-left: 15px;margin-right: 15px;">
      <div class="am-u-sm-12">
        <div class="am-cf " style="padding-bottom: 10px;">
          <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">站内信</strong> / <small>收件箱</small></div>
        </div>
        <div class="am-g">
            ...
            <div class="am-fl am-cf">
              <div class="am-btn-toolbar am-fl">
                <div class="am-btn-group am-btn-group-xs">
                  <button onclick=javascript:window.location.href="<?php echo U('Message/Send');?>"; type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 写信息</button>
                </div>
            ...
            <form class="am-form">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="am-table am-table-striped am-table-hover table-main" id="tableData">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                    ...
                    <td class="">
                      <a href="<?php echo U('Message/View');?>?id=<?php echo ($vo["id"]); ?>">
                        <?php echo ($vo["title"]); ?>
                      </a>
                    </td>
                    <td class=""><?php echo ($vo["from"]["username"]); ?></td>
                    <td class="hidden-xs">
