      ...
      <div class="am-u-sm-12">
            ...
            <div class="am-fl am-cf">
              <div class="am-btn-toolbar am-fl">
                <div class="am-btn-group am-btn-group-xs">
                  <button onclick=javascript:window.location.href="<?php echo U('CT/Index');?>"; type="button" class="am-btn am-btn-default"><span class="am-icon-bug"></span> 返回</button>
                </div>
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Class/UpdateClass');?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    <input type="text" class="col-sm-6 col-xs-12" name="class_name" id="class_name" value="<?php echo ($data[0]["class_name"]); ?>">
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    ...
                    <select class="form-control col-sm-6 col-xs-12" name="college" id="college">
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['college_id']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["college_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                </div>
                ...
                <div class="am-g am-margin-top-sm">
                  ...
                  <div class="am-u-sm-4 am-u-end">
                    ...
                    <select class="form-control col-sm-6 col-xs-12" name="major" id="major">
                      <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $data[0]['major_id']): ?>selected<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["major_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                  </div>
                </div>
