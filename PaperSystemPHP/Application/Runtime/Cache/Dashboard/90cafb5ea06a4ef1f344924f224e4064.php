      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Score/UpdateScore');?>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 150px;" type="number" min="0" max="100" name="score" value="<?php echo ($sc["score"]); ?>">
