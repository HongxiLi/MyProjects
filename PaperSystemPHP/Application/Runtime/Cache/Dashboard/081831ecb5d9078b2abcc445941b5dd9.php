            ...
            <div class="col-lg-12">
                <div class="widget">
                    ...
                    <div class="widget-content">
                        <div class="body">
                            <form data-validate="parsley" method="post" novalidate="" class="form-horizontal label-left" id="form" action="<?php echo U('LocalShop/UpdateShop');?>" enctype="multipart/form-data">
                                <fieldset>
