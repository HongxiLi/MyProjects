  ...
  <div class="am-g" style="padding: 10px;border: 1px solid #ddd;margin-left: 15px;margin-right: 15px;">
    <div class="am-u-sm-12">
      <div class="am-cf " style="padding-bottom: 10px;">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">留言板</strong> / <small>数据列表</small></div>
      </div>
      <div class="am-g">
          ...
          <div class="am-fl am-cf">
            <div class="am-btn-toolbar am-fl">
              <div class="am-btn-group am-btn-group-xs">
                ...
                <button onclick=javascript:window.location.href="<?php echo U('Board/Add');?>"; type="button" class="am-btn am-btn-default"><span class="am-icon-bug"></span> 发布留言</button>
      ...
      <div class="am-g">
        <div class="am-u-sm-12">
          ...
          <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Message/AddMsg');?>">
