      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form  data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('User/updateProfile');?>">
                ...
                <fieldset>
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 250px;" type="text" class="col-sm-6 col-xs-12" name="prefix" id="prefix" readonly value="<?php echo ($vo["username"]); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 250px;" type="text" value="<?php echo ($vo["realname"]); ?>" class="col-xs-12 parsley-validated" required="" name="realname" id="realname">
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                  ...
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 250px;" type="email" value="<?php echo ($vo["email"]); ?>" name="email" class="col-xs-12" id="email">
                      </div>
                    </div>
                  </div>
                  <div class="control-group">
                    ...
                    <div class="col-md-9">
                      <div class="form-group">
                        <input style="width: 250px;" type="text" value="<?php echo ($vo["tel"]); ?>" name="tel" class="col-xs-12" id="tel">
                      </div>
                    </div>
                  </div>
                </fieldset>
