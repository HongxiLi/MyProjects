      ...
      <div class="am-u-sm-12">
        ...
        <div class="am-g">
          <div class="am-u-sm-12">
              ...
              <form enctype="multipart/form-data" data-validate="parsley" method="post" novalidate="" class="am-form" id="form" action="<?php echo U('Student/ImportStudentExcel');?>">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    <div class="col-md-8">
                      ...
                      <a class="btn btn-primary" href="<?php echo U('DownLoad/StImportTpl');?>" target="_blank">下载模板</a>
                      <br/> <br/>
                      示例Excel格式. <br/>
